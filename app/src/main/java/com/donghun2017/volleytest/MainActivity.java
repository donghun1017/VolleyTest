package com.donghun2017.volleytest;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickBtn(View v){
        String url = "http://edi004.dothome.co.kr/httpTest.html";
        //url="http://daum.co.net/index.html";
    ...
    public void clickBtn2(View v){
        String url = "http://edi004.dothome.co.kr/img/Penguins.jpg";
    ...
    public void clickBtn3(View v){
        String url = "http://edi004.dothome.co.kr/data.json";
    ...
    public void clickBtn4(View v){
        String url1="http://edi004.dothome.co.kr/httpTest.html";
        String url2="http://edi004.dothome.co.kr/img/Penguins.jpg";
        String url3="http://edi004.dothome.co.kr/data.json";
    ...
    public void clickBtn5(View v){
        ...
        String url="http://edi004.dothome.co.kr/postTest.php";
